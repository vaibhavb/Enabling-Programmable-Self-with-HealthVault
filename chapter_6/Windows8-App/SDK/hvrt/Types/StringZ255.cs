...
{
    public sealed class StringZ255 : IHealthVaultType, IConstrainedString
    {
        private ConstrainedStringImpl m_value = new ConstrainedStringImpl(0, 255);

        public StringZ255()
        {
        }

        public StringZ255(string val)
        {
            m_value.Value = val;
        }
